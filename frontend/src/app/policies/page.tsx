    ...
    <main className="flex min-h-screen bg-black">
      ...
      <section className="flex-1">
        ...
        <div className="p-8">
          ...
          <div className="mb-10">
            <CreatePolicyForm onCreated={loadPolicies} />
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-950">
                <tr>
                  ...
                  <th className="text-left text-gray-400 p-5">Expiration</th>
              ...
              <tbody>
                {policies.map((policy) => (
                  ...
                  >
                    <td className="p-5 text-white">{policy.policy_number}</td>
                    <td className="p-5 text-gray-300">{policy.customer_id}</td>
                    <td className="p-5 text-gray-300">{policy.line_of_business}</td>
                    <td className="p-5 text-gray-300">{policy.carrier}</td>
                    <td className="p-5 text-gray-300">${policy.premium}</td>
                    <td className="p-5 text-gray-300">{policy.expiration_date}</td>
                    <td className="p-5">
