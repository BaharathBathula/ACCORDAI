    ...
    <main className="flex min-h-screen bg-black">
      ...
      <section className="flex-1">
        ...
        <div className="p-8">
          ...
          <div className="mb-10">
            <CreateClaimForm onCreated={loadClaims} />
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-950">
                <tr>
                  ...
                  <th className="text-left text-gray-400 p-5">Customer ID</th>
                  <th className="text-left text-gray-400 p-5">Policy ID</th>
                  <th className="text-left text-gray-400 p-5">Type</th>
                  <th className="text-left text-gray-400 p-5">Reserve</th>
                  <th className="text-left text-gray-400 p-5">Loss Date</th>
              ...
              <tbody>
                {claims.map((claim) => (
                  ...
                  >
                    <td className="p-5 text-white">{claim.claim_number}</td>
                    <td className="p-5 text-gray-300">{claim.customer_id}</td>
                    <td className="p-5 text-gray-300">{claim.policy_id}</td>
                    <td className="p-5 text-gray-300">{claim.claim_type}</td>
                    <td className="p-5 text-gray-300">${claim.reserve_amount}</td>
                    <td className="p-5 text-gray-300">{claim.loss_date}</td>
                    <td className="p-5">
